...
import { Sparkles, Upload, RefreshCw, RotateCcw } from "lucide-react";
...
const CoverImageEditor = forwardRef(
  (
    ...
    const handleReset = () => {
      onImageGenerated(initialFrontCover);
      onTitleChange(initialAlbumTitle);
      onArtistChange(initialArtistName);
      setPrompt("");
      setGeneratedImages([]);
