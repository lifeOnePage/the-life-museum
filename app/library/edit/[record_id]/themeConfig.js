...
export const UNIFIED_THEMES = {
  ...
  children_1: {
    ...
    name: "육아 화이트",
    nameEn: "Parent White",
    description: "화이트 배경에 폴라로이드 프레임과 타임라인",
    descriptionEn: "White background with a polaroid frame and timeline",
    bg: "#ffffff",
    accent: "#3a352e",
    text: "#8a8478",
  },
  children_2: {
    ...
    name: "육아 브라운",
    nameEn: "Parent Brown",
    description: "황토색 배경에 폴라로이드 프레임과 타임라인",
    descriptionEn: "Ochre background with a polaroid frame and timeline",
    bg: "#e8ddc9",
    accent: "#4a3f2e",
    text: "#8f7d5f",
  },
