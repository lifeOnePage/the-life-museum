  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="absolute top-2 right-2 w-6 h-6 bg-black/70 rounded-full flex items-center justify-center hover:bg-black/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-black/70 z-10 cursor-pointer"
      >
        <svg
          width="12"
          height="12"
